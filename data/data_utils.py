...
if __name__ == '__main__':
  ...
  ubuntu_raw_path = "./data/malmul/%s.txt"
  ubuntu_pkl_path = "./data/malmul/ubuntu_%s.pkl"
  bert_pretrained_dir = "./resources"
  ...
  for data_type in ["train"]:
    data = ubuntu_utils.read_raw_file(data_type)
    ubuntu_utils.make_post_training_corpus(data, "./data/malmul/ubuntu_post_training.txt")
